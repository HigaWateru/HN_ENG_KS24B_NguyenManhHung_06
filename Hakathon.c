    ...
    do{
        ...
        switch(d){
            ...
            case 2:
                ...
                break;
            case 3:
                for(int i=0;i<n;i++)if(soHH(a[i]))dem++;
            ...
            case 8:
                ...
                scanf("%d",&gt);
                for(int i=0;i<n;i++)if(a[i]==gt)checkTM++;
                if(checkTM==0)printf("Gia tri khong ton tai trong mang\n");
                else printf("Gia tri co ton tai trong mang");
                break;
            case 10:
                checkTM=0;
